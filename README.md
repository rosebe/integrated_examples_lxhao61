...
#### &emsp;Xray 的回落应用
1. [Xray(Trojan+RAW+TLS)+Nginx\Caddy](https://github.com/lxhao61/integrated-examples/tree/main/Xray(Trojan%2BRAW%2BTLS)%2BNginx%5CCaddy)（Trojan 回落应用，兼容原版 Trojan 的应用。标记为 F。）
2. [Xray(VLESS+Vision+TLS)+Nginx\Caddy](https://github.com/lxhao61/integrated-examples/tree/main/Xray(VLESS%2BVision%2BTLS)%2BNginx%5CCaddy)（XTLS Vision 应用。标记为 E。）
